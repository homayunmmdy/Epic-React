      ...
      <div className="mx-auto">
        <div className="relative isolate overflow-hidden  px-6 py-24   sm:px-24 xl:py-32">
          ...
          <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8">
            با پیشرفت های {SiteConfig.name} همگام باشید! برای به روز رسانی های
            انتخابی و قابل توجه به خبرنامه ما بپیوندید.
          </p>
          {message && (
            <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8">
              {message}
          ...
          >
            ...
            <input
              ...
              required
              className="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-slate-300 shadow-xl ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
